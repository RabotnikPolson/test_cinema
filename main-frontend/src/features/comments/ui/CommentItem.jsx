        ...
        <div className={`comment ${isReply ? "reply" : ""}`}>
            <div className="comment-avatar">
                {node.authorAvatarUrl ? (
                    <img src={node.authorAvatarUrl} alt="" className="comment-avatar-img" />
                ) : (
            ...
            <div className="comment-body">
                <div className="comment-meta">
                    <Link to={`/activity/${node.userId}`} state={{ username: node.authorUsername }} className="comment-author-link">
                        <strong>{node.authorUsername ?? t("comments.deletedUser")}</strong>
                    </Link>
                ...
                <div className="comment-actions">
                    <button onClick={() => onReact("👍")}>
                        ...
                        {node.totalReactions || t("comments.like")}
                    </button>
                ...
                {replying && (
                    <div className="reply-form" style={{ marginTop: '12px' }}>
                        <CommentForm
                            value={replyText}
